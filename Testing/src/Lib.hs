...
prop_tree t b = (not (Blockchain.blocktree_eq (Blockchain.extendTree t b) t)) ==> (Blockchain.blockpool_eq (Blockchain.allBlocks (Blockchain.extendTree t b)) ((Blockchain.allBlocks t)++[b]))
